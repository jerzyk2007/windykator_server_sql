...
// AS3_PRACA_KROTOSKI_ELECTROMOBILITY
...
const updateDataKEM = async () => {
    ...
    `;
        ...
        addDocumentToDatabase("KEM").then((result) => {
            connect_SQL.query(
...
cron.schedule('45 06 * * *', updateDataKEM, {
